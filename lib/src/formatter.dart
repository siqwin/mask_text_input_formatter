...
class MaskTextInputFormatter implements TextInputFormatter {
  ...
  /// Note: you need to call this method if you clear the text of the
  /// TextField because it doesn't call the formatter when it has empty text
  void clear() {
    _resultTextMasked = "";
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (customFormatEditUpdate != null) {
