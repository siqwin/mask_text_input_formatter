...
void main() {
  ...
  group('Mask Text Input Formatter Tests', () {
    test('Type', () {
      ...
      var currentTextEditingValue = const TextEditingValue();
    ...
    test('Insert - Start', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      final currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '01234567', selection: TextSelection.collapsed(offset: 8)));
    ...
    test('Insert - End', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '01234567', selection: TextSelection.collapsed(offset: 8)));
    ...
    test('Insert - Overflow', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      final currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '01234567890123456', selection: TextSelection.collapsed(offset: 18)));
      expect(currentTextEditingValue, const TextEditingValue(text: '+0 (123) 456-78-90', selection: TextSelection.collapsed(offset: 18)));
      expect(maskTextInputFormatter.isFill(), true);
      expect(maskTextInputFormatter.getMaskedText(), '+0 (123) 456-78-90');
      expect(maskTextInputFormatter.getUnmaskedText(), '01234567890');
    ...
    test('Insert - Overflow - 2', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '###');
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '123', selection: TextSelection.collapsed(offset: 3)));
    ...
    test('Insert - Incorrect symbols', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      final currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '0 (123) 456-78-90', selection: TextSelection.collapsed(offset: 18)));
      expect(currentTextEditingValue, const TextEditingValue(text: '+0 (123) 456-78-90', selection: TextSelection.collapsed(offset: 18)));
      expect(maskTextInputFormatter.isFill(), true);
      expect(maskTextInputFormatter.getMaskedText(), '+0 (123) 456-78-90');
      expect(maskTextInputFormatter.getUnmaskedText(), '01234567890');
    ...
    test('Remove - Part - 1', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '01234567890', selection: TextSelection.collapsed(offset: 11)));
    ...
    test('Remove - Part - 2', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '(###) ###-##-##');
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '2555555', selection: TextSelection.collapsed(offset: 11)));
    ...
    test('Replace - Part - 2', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '04321567890', selection: TextSelection.collapsed(offset: 11)));
    ...
    test('Replace - Part - 3', () {
      final maskTextInputFormatter = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '12223334455', selection: TextSelection.collapsed(offset: 11)));
    ...
    test('Update mask', () {
      ...
      var currentTextEditingValue = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: '12345678'));
    ...
    test('Disabled mask', () {
      ...
      var result = maskTextInputFormatter.formatEditUpdate(const TextEditingValue(), const TextEditingValue(text: someText, selection: TextSelection.collapsed(offset: 12)));
